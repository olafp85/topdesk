			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"topdesk-display": {
								"semanticObject": "topdesk",
								"action": "display",
								"description": "TOPdesk status comparison",
								"title": "TOPdesk",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=topdesk",
									"url": sap.ui.require.toUrl("topdesk")
								}
							}
						}
					}
